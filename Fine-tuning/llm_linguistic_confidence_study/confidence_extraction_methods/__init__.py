...
from .logits_perplexity import LogitsPerplexityConfidenceExtractor
...
class ConfidenceExtractor:
    ...
    def get_confidence_extractor(self, confidence_extraction_method_name):
        ...
        elif confidence_extraction_method_name == "p_true":
        ...
        elif confidence_extraction_method_name == "logits_perplexity":
            return LogitsPerplexityConfidenceExtractor(self.confidence_extraction_method_cfg, self.qa_model_cfg)
        else:
